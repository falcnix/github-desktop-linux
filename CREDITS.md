...
- **What they made:** The entire GitHub Desktop application — the user
...
- **License:** MIT
- **What they made:** The long-running community fork that brought GitHub
  Desktop to Linux — Linux build configuration, `.deb`/`.rpm`/AppImage
  packaging, dependency handling, and release automation. This `.deb` follows
  that lineage of Linux packaging work.
...
- **What they made:** The cross-platform runtime (Chromium + Node.js) that
  GitHub Desktop is built on. Version `42.0.1` is bundled in this package.
...
**upstream** projects above — they did the real work.
