...
| **Package** | `github-desktop_3.5.13~beta1-1_amd64.deb` |
...
committed to the repository (it is ~152 MB).
...
- **[GitHub Desktop — `desktop/desktop`](https://github.com/desktop/desktop)**
  © GitHub, Inc. and GitHub Desktop contributors. The entire application.
  Licensed under the [MIT License](https://github.com/desktop/desktop/blob/development/LICENSE).
...
- **[Electron](https://github.com/electron/electron)** © Electron contributors /
  OpenJS Foundation — the application runtime (v42.0.1).
